...
/* // Old parameters before asia haptics
#define GESTURE_MYO_PITCH_MIN -0.4
#define GESTURE_MYO_PITCH_MAX 1.0
#define GESTURE_MYO_LEFT_SWIPE_YAW -0.7
#define GESTURE_MYO_RIGHT_SWIPE_YAW 0.7
#define GESTURE_MYO_ROLL_MIN -2.5
#define GESTURE_MYO_ROLL_MAX -0.4*/

#define GESTURE_MYO_PITCH_MIN -1.0
#define GESTURE_MYO_PITCH_MAX 1.0
#define GESTURE_MYO_LEFT_SWIPE_YAW -0.5
#define GESTURE_MYO_RIGHT_SWIPE_YAW 0.7
#define GESTURE_MYO_ROLL_MIN -3.0
#define GESTURE_MYO_ROLL_MAX -0.1

	// LeapMotion flat hand gestures
#define GESTURE_FLAT_HAND_PITCH_MIN -0.5
